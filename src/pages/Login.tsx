...
import { Activity, Mail, Lock, Loader2, Heart, Brain, Stethoscope } from 'lucide-react';
...
const Login = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      toast({
        title: "Welcome back!",
        description: "Successfully logged in to MedTrailMatch",
      });
      navigate('/');
    } catch (error) {
      toast({
      ...
      <div className="hidden lg:flex lg:w-1/2 gradient-medical relative overflow-hidden">
        ...
        <div className="relative z-10 flex flex-col justify-center items-center w-full p-12 text-primary-foreground">
          ...
          <p className="text-xl text-primary-foreground/90 text-center max-w-md mb-12">
            AI-Powered Clinical Trial Eligibility & Health Risk Prediction Platform
          </p>
        ...
        <div className="w-full max-w-md">
          ...
          <div className="medical-card">
            <div className="mb-8">
              ...
              <p className="text-muted-foreground">Sign in to continue your health analysis</p>
            </div>
